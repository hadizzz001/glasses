    ...
    <div className="u-clearfix u-sheet u-valign-middle u-sheet-1">
      <div className="u-align-center u-container-style u-group u-group-1">
        <div className="u-container-layout u-valign-middle">
          ...
          <p className="  myGray" > 
            poptical sunwear specializes in premium pool equipment and exciting water toys designed to elevate your aquatic experience. From maintenance essentials to fun floatables, we bring innovation and enjoyment to every splash.
          </p>
