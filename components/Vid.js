  ...
  return (
    <div className="flex flex-col items-center justify-center w-full "> 
      ...
      <div className="relative w-[380px] h-[500px] md:w-[1200px] md:h-[600px] rounded-2xl overflow-hidden md:mt-[150px]">
        ...
        <button onClick={() => router.push("/shop")} className="text-3x1 absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-[#222] text-white px-8 py-2 rounded-lg shadow-md  transition">
          Shop Now
        </button>
      </div>
    </div>
